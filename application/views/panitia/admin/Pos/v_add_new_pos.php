    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php echo form_open("panitia/pos/tambah/", array("class" => "form-horizontal")); ?>                    
                    <div class="form-group">
                        <label class="col-md-2 control-label">Nama Pos :</label>
                        <div class="col-md-10">
                            <?php echo form_input(array("name" => "nama", "placeholder" => "Nama Pos", "maxlength" => "45", "class" => "form-control", "required" => "true", "value" => set_value("nama", ""))); ?>                       
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">Jenis Pos :</label>
                        <div class="col-md-10">
                            <?php echo form_dropdown("jenis", $jenis, set_value("jenis", 0), "class='form-control' required"); ?>                       
                        </div>
                    </div>
                    <div class="form-group">
